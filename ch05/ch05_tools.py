...
# Retriever 1 - Get movies by titles
...
# Retriever 2 - Get movies by actor names
...
def answer_given(answer: str):
    """Extract the answer from the conversation and return it to the user."""
    return answer